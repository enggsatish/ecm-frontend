...
import { FileText, CheckSquare, Clock, TrendingUp, Loader2, ArrowRight, Search, User, X } from 'lucide-react'
          ...
          <div className="px-5 py-4 border-b border-gray-100">
            ...
            {selectedParty && (
              <div className="mt-2 flex items-center gap-2 px-3 py-1.5 bg-indigo-50 rounded-lg border border-indigo-100">
                ...
                <span className="text-xs font-semibold text-indigo-900">{selectedParty.displayName}</span>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              ...
              <Link to="/workflow" className="flex items-center gap-1 text-xs text-primary-600 hover:text-primary-700 font-semibold">
                View all <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
